        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="homePage" class="navbar-brand"><img class="display-6" src="img/floralogo.png" alt="Flora Logo" width="200"></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <c:if test="${not empty sessionScope.USER}">
                                <!--                Manager Session-->
                                <c:if test="${sessionScope.USER.role == sessionScope.isAdmin}">
                                    <a href="#" class="nav-item nav-link">Manage Product</a>
                                </c:if>
                                <!--                Delivery Session-->
                                <c:if test="${sessionScope.USER.role == sessionScope.isDelivery}">
                                    <a href="#" class="nav-item nav-link">Delivery Order</a>
                                </c:if>
                                <!--                Seller Session-->
                                <form action="ProductManagementAction">
                                    <button name="btAction" type="submit" class="nav-item nav-link">Manage Shop</button>
                                </form>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-secondary">Flora Shop</h4>      
                        <c:set var="user" value="${sessionScope.USER.fullName}"/>
                        <c:if test="${empty user}">
                            <h1 class="mb-5 display-3 text-primary">Hi, Guest</h1>
                            <h1 class="mb-5 display-3 text-primary">Welcome to Flora</h1>
                        </c:if>   
                        <c:if test="${not empty user}">
                            <h1 class="mb-5 display-3 text-primary">Hi, ${sessionScope.USER.fullName}</h1>
                            <h1 class="mb-5 display-3 text-primary">Welcome to Flora</h1>
                        </c:if>                     
